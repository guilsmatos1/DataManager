...
=====================
Cache management subcommands for PortifolioCLI.
"""
...
from trademachine.portifolio_master_cli.loader import _parse_mt5_report_file
...
class CacheMixin:
    """Cache management functionality for PortifolioCLI."""

    def _cache_service(self, cache_path: str | None = None) -> CacheService:
        """Returns a cache service bound to the active cache path."""
        return CacheService(
            cache_path or self.default_config.get("cache_path", "cache.parquet")  # type: ignore[attr-defined]
        )
    ...
    def cache_info(self, cache_path: str | None = None) -> None:
        ...
        path = cache_path or self.default_config.get("cache_path", "cache.parquet")  # type: ignore[attr-defined]
        try:
    ...
    def cache_rebuild(self, directory: str, cache_path: str | None = None) -> None:
        ...
        if cache_path:
            self.default_config["cache_path"] = cache_path  # type: ignore[attr-defined]
        self.loaded_expert_names = []  # type: ignore[var-annotated]
    ...
    def cache_save(self, destination: str, cache_path: str | None = None) -> None:
        ...
        source = cache_path or self.default_config.get("cache_path", "cache.parquet")  # type: ignore[attr-defined]
    ...
    def cache_load(self, source: str, cache_path: str | None = None) -> None:
        ...
        target = cache_path or self.default_config.get("cache_path", "cache.parquet")  # type: ignore[attr-defined]
        try:
