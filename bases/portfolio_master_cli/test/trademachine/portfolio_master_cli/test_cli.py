"""
Tests for PortfolioCLI pipeline:
...
def loaded_cli():
    """PortfolioCLI with real strategies loaded from tests/reports/."""
    cli = PortfolioCLI()
...
def test_save_output_dir_creates_all_files(loaded_cli, tmp_path):
    ...
    with patch(
        "trademachine.portfolio_master_cli.cli.generate_portfolio_report_html",
