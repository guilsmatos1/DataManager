...
======================
Drawdown pairing functionality for PortfolioCLI.
"""
...
from trademachine.portfoliomaster.public import PairingService, ValidationError
...
class PairingMixin:
    ...
    def drawdown_pairing(
        ...
        for row in rows:
            ...
            print(
                f"{Fore.GREEN}{row.name[:name_len]:<{name_len}} {Fore.GREEN}| "
                f"{Fore.CYAN}{base_str:>9} {Fore.GREEN}| {Fore.YELLOW}{lot_str:>10} {Fore.GREEN}| "
                f"{Fore.MAGENTA}{row.orig_dd:>12,.2f} {Fore.GREEN}| {Fore.MAGENTA}{row.paired_dd:>12,.2f} {Fore.GREEN}| "
                f"{Fore.RED if row.diff < 0 else Fore.GREEN}{row.diff:>+10,.2f} {Fore.GREEN}| "
