...
def test_generate_portfolio_report_html_creates_file(
    mock_open, sample_portfolios, sample_strategies, tmp_path
):
...
@patch("webbrowser.open")
def test_generate_portfolio_report_html_handles_errors(mock_open, tmp_path):
...
@patch("webbrowser.open")
def test_generate_montecarlo_report_html(mock_open, tmp_path):
