...
GEMINI_PATH = REPO_ROOT / "projects" / "portifoliomaster" / "GEMINI.md"
CLAUDE_PATH = REPO_ROOT / "projects" / "portifoliomaster" / "CLAUDE.md"
AGENTS_PATH = REPO_ROOT / "projects" / "portifoliomaster" / "AGENTS.md"
DOC_PATHS = (GEMINI_PATH, CLAUDE_PATH, AGENTS_PATH)

CURRENT_DOC_TOKENS = [
    "uv run portifoliomaster load",
    "uv run portifoliomaster benchmark",
    "cache save",
    "cache load",
    "cache merge",
    "--greedy-loops",
...
LEGACY_DOC_TOKENS = [
    "portifoliomaster --optimize",
    "portifoliomaster drawdown pairing",
