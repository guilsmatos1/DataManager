...
from trademachine.portfoliomaster.core.exceptions import DataError
...
class CacheService:
    ...
    def lots_cache_path(cache_path: str) -> str:
        ...
        return PortfolioManager._lots_cache_path(cache_path)  # type: ignore[no-any-return]
    ...
    def save_snapshot(self, destination: str) -> None:
        ...
        if os.path.exists(self.active_lots_path):
            ...
            os.makedirs(
                os.path.dirname(os.path.abspath(destination_lots)) or ".", exist_ok=True
            )
    ...
    def load_snapshot(self, source: str) -> tuple[str, str | None]:
        ...
        if os.path.exists(source_lots):
            os.makedirs(
                os.path.dirname(os.path.abspath(self.active_lots_path)) or ".",
                exist_ok=True,
            )
